...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Client Representative'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Marketing Manager', 'Client Representative', 'Content Creator', 'Business Owner'];
  const addOns: string[] = ['chat'];
  const applicationName = `RapAdds`;
