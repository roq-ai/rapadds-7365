...
import { getMarketingPlanById, updateMarketingPlanById } from 'apiSdk/marketing-plans';
...
function MarketingPlanEditPage() {
  ...
  const handleSubmit = async (values: MarketingPlanInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateMarketingPlanById(id, values);
      mutate(updated);
      resetForm();
